                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:340px">
                   <table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
                     ...
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-bottom:20px;padding-top:30px"><h1 style="Margin:0;line-height:38px;mso-line-height-rule:exactly;font-family:Limelight, sans-serif;font-size:32px;font-style:normal;font-weight:normal;color:#333333">Привет,&nbsp;&nbsp;{{name}}</h1></td> *////////////////////////////////////////////////////////////////
                     </tr>
                     <tr>
                     ...
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-bottom:20px;padding-top:30px"><h2 style="Margin:0;line-height:38px;mso-line-height-rule:exactly;font-family:Limelight, sans-serif;font-size:32px;font-style:normal;font-weight:normal;color:#333333">Активируйте свою учетную запись по ссылки внизу.</h2></td>
                     </tr>
                     <tr>
                      <td align="center" style="padding:0;Margin:0;padding-top:10px;padding-bottom:10px;font-size:0">
                       <table border="0" width="35%" height="100%" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px">
